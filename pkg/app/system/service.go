...
func (svc *Service) Connect(ctx context.Context, connectionID, userID string) error {
...
func (svc *Service) Disconnect(ctx context.Context, connectionID string) error {
