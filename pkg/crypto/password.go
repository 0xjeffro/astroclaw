...
// Password hashing using Argon2id. The PHC encoding/decoding code is
// adapted from github.com/alexedwards/argon2id (MIT licensed). It enforces
// the Argon2id variant and cryptographically secure random salts.
